...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Shura\PycharmProjects\pythonProject\dio-twitter-py-master'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Shura\PycharmProjects\pythonProject\dio-twitter-py-master\Scripts\deactivate.nu'
